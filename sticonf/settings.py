"""
Django settings for sticonf project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-11j2tf5%ajj3(8)on3g1!n*5g6pyi8^=7**^ng^4^a$abcp(ln')
...
WSGI_APPLICATION = 'sticonf.wsgi.application'
